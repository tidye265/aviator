...
// Lumikizanani ndi server yomweyi yomwe ikupatsa ma data a live
...
export const Provider = ({ children }: any) => {
  ...
  // Madatala oyambirira a state (izi zimagwira ntchito ndi index.tsx)
  ...
  // WEBSOCKET LISTENERS WITH SAFE STATE MANAGEMENT
  React.useEffect(() => {
    socket.on("connect", () => {
    ...
    socket.on("gameState", (incomingState: GameStatusType) => {
      // Ingolandirani madatala a UI ndikusiya `index.tsx` kuchita ntchito yake.
      setGameState(incomingState);
      
      // Izi ziyankha Unity kokha ngati "GameManager" ilipo
      try {
