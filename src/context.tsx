...
// YASINTHIDWA PANO: Kululumikizana mwachindunji ndi Hugging Face popanda kugwiritsa ntchito config.wss
const socket = io("https://moskonx-tidye-shooter-game-server.hf.space", {
  transports: ["websocket", "polling"], // Izi zithandiza kuti isavutike pa Hugging Face
  secure: true,
  reconnection: true,                   // Izi zipanga kuti ibweleze yokha ngati iduka
...
export const Provider = ({ children }: any) => {
  ...
  React.useEffect(() => {
    socket.on("connect", () => {
      ...
      console.log("Mulumikizano Wathunthu ndi Server (Connected): ", socket.connected);
    });
