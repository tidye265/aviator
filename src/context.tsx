...
export const Provider = ({ children }: any) => {
  ...
  React.useEffect(() => {
    ...
    // FIXED: Listener for Game State sync
    socket.on("gameState", (incomingState: any) => {
        // 1. Kusintha state ya game ndi mapping yoyenera
        setGameState({
            ...
            time: incomingState.timeRemaining // FIX: Map this to 'time' so progress bar works
        });
