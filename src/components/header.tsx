...
export default function Header() {
  ...
  // ✅ Ma State a Menu, Chat ndi Toggles monga Aviator enieni
  ...
  return (
    <div className="header flex-none items-center" style={{ position: "relative", zIndex: 1000 }}>
      {/* ✅ Tsopano ithetsa TypeScript Error pogwiritsa ntchito (state as any) */}
      {(!state?.userInfo || (state as any)?.loading) && (
        <div style={{
          position: "absolute",
          top: 0,
          left: 0,
      ...
      <div className="header-container">
        ...
        <div className="second-block" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          {/* ✅ Balance Layout Yapamwamba (Exactly Aviator: No Coin, Pill-shape) */}
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill={chatOpen ? "#e51c24" : "#aeaeae"}>
